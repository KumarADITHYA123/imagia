(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_gsap_a4b805._.js", {
...
"[project]/node_modules/gsap/dist/ScrollTrigger.js [app-client] (ecmascript)": (function({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, k: __turbopack_refresh__, m: module, e: exports, t: require }) { !function() {

(function(global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) : typeof define === 'function' && define.amd ? ((r)=>r !== undefined && __turbopack_export_value__(r))(factory(exports)) : (global = global || self, factory(global.window = global.window || {}));
  ...
  */ var gsap, _coreInitted, _clamp, _win, _doc, _docEl, _body, _isTouch, _pointerType, ScrollTrigger, _root, _normalizer, _eventTypes, _context, _getGSAP = function _getGSAP() {
    ...
    }, _getTarget = function _getTarget(t, self1) {
        return (self1 && self1._ctx && self1._ctx.selector || gsap.utils.toArray)(t)[0] || (typeof t === "string" && gsap.config().nullTargetWarn !== false ? console.warn("Element not found:", t) : null);
    ...
    var Observer = function() {
        ...
        _proto.init = function init(vars) {
            ...
            var id, onStopDelayedCall, dragged, moved, wheeled, locked, axis, self1 = this, prevDeltaX = 0, prevDeltaY = 0, passive = vars.passive || !preventDefault, scrollFuncX = _getScrollFunc(target, _horizontal), scrollFuncY = _getScrollFunc(target, _vertical), scrollX = scrollFuncX(), scrollY = scrollFuncY(), limitToTouch = ~type.indexOf("touch") && !~type.indexOf("pointer") && _eventTypes[0] === "pointerdown", isViewport = _isViewport(target), ownerDoc = target.ownerDocument || _doc, deltaX = [
                ...
                return (self1.event = e) && ignore && ~ignore.indexOf(e.target) || isPointerOrTouch && limitToTouch && e.pointerType !== "touch" || ignoreCheck && ignoreCheck(e, isPointerOrTouch);
                ...
                var dx = self1.deltaX = _getAbsoluteMax(deltaX), dy = self1.deltaY = _getAbsoluteMax(deltaY), changedX = Math.abs(dx) >= tolerance, changedY = Math.abs(dy) >= tolerance;
                onChange && (changedX || changedY) && onChange(self1, dx, dy, deltaX, deltaY);
                if (changedX) {
                    onRight && self1.deltaX > 0 && onRight(self1);
                    onLeft && self1.deltaX < 0 && onLeft(self1);
                    onChangeX && onChangeX(self1);
                    onToggleX && self1.deltaX < 0 !== prevDeltaX < 0 && onToggleX(self1);
                    prevDeltaX = self1.deltaX;
                    deltaX[0] = deltaX[1] = deltaX[2] = 0;
                }
                if (changedY) {
                    onDown && self1.deltaY > 0 && onDown(self1);
                    onUp && self1.deltaY < 0 && onUp(self1);
                    onChangeY && onChangeY(self1);
                    onToggleY && self1.deltaY < 0 !== prevDeltaY < 0 && onToggleY(self1);
                    prevDeltaY = self1.deltaY;
                ...
                locked && !(locked = false) && onLockAxis && onLockAxis(self1);
                if (wheeled) {
                    onWheel(self1);
                    wheeled = false;
                }
                ...
                if (lockAxis && !axis) {
                    self1.axis = axis = Math.abs(x) > Math.abs(y) ? "x" : "y";
                    locked = true;
                }
                if (axis !== "y") {
                    deltaX[2] += x;
                    self1._vx.update(x, true);
                }
                if (axis !== "x") {
                    deltaY[2] += y;
                    self1._vy.update(y, true);
                }
                debounce ? id || (id = requestAnimationFrame(update)) : update();
                ...
                var x = e.clientX, y = e.clientY, dx = x - self1.x, dy = y - self1.y, isDragging = self1.isDragging;
                self1.x = x;
                self1.y = y;
                if (isDragging || Math.abs(self1.startX - x) >= dragMinimum || Math.abs(self1.startY - y) >= dragMinimum) {
                    onDrag && (dragged = true);
                    isDragging || (self1.isDragging = true);
                    onTouchOrPointerDelta(dx, dy);
                    isDragging || onDragStart && onDragStart(self1);
                }
            }, _onPress = self1.onPress = function(e) {
                if (_ignoreCheck(e, 1) || e && e.button) {
                    return;
                }
                self1.axis = axis = null;
                onStopDelayedCall.pause();
                self1.isPressed = true;
                e = _getEvent(e);
                prevDeltaX = prevDeltaY = 0;
                self1.startX = self1.x = e.clientX;
                self1.startY = self1.y = e.clientY;
                self1._vx.reset();
                self1._vy.reset();
                _addListener(isNormalizer ? target : ownerDoc, _eventTypes[1], _onDrag, passive, true);
                self1.deltaX = self1.deltaY = 0;
                onPress && onPress(self1);
            }, _onRelease = self1.onRelease = function(e) {
                if (_ignoreCheck(e, 1)) {
                    return;
                }
                _removeListener(isNormalizer ? target : ownerDoc, _eventTypes[1], _onDrag, true);
                var isTrackingDrag = !isNaN(self1.y - self1.startY), wasDragging = self1.isDragging, isDragNotClick = wasDragging && (Math.abs(self1.x - self1.startX) > 3 || Math.abs(self1.y - self1.startY) > 3), eventData = _getEvent(e);
                ...
                self1.isDragging = self1.isGesturing = self1.isPressed = false;
                onStop && wasDragging && !isNormalizer && onStopDelayedCall.restart(true);
                onDragEnd && wasDragging && onDragEnd(self1);
                onRelease && onRelease(self1, isDragNotClick);
            }, _onGestureStart = function _onGestureStart(e) {
                return e.touches && e.touches.length > 1 && (self1.isGesturing = true) && onGestureStart(e, self1.isDragging);
            }, _onGestureEnd = function _onGestureEnd() {
                return (self1.isGesturing = false) || onGestureEnd(self1);
                ...
                var x = e.clientX, y = e.clientY, dx = x - self1.x, dy = y - self1.y;
                self1.x = x;
                self1.y = y;
                moved = true;
                onStop && onStopDelayedCall.restart(true);
                ...
                return _ignoreCheck(e) || _getEvent(e, preventDefault) && onClick(self1);
            };
            onStopDelayedCall = self1._dc = gsap.delayedCall(onStopDelay || 0.25, onStopFunc).pause();
            self1.deltaX = self1.deltaY = 0;
            self1._vx = _getVelocityProp(0, 50, true);
            self1._vy = _getVelocityProp(0, 50, true);
            self1.scrollX = scrollFuncX;
            self1.scrollY = scrollFuncY;
            self1.isDragging = self1.isGesturing = self1.isPressed = false;
            _context(this);
            self1.enable = function(e) {
                if (!self1.isEnabled) {
                    ...
                    self1.isEnabled = true;
                    e && e.type && _onPress(e);
                    onEnable && onEnable(self1);
                }
                return self1;
            };
            self1.disable = function() {
                if (self1.isEnabled) {
                    _observers.filter(function(o) {
                        return o !== self1 && _isViewport(o.target);
                    ...
                    self1.isEnabled = self1.isPressed = self1.isDragging = false;
                    onDisable && onDisable(self1);
                }
            };
            self1.kill = self1.revert = function() {
                self1.disable();
                var i = _observers.indexOf(self1);
                i >= 0 && _observers.splice(i, 1);
                _normalizer === self1 && (_normalizer = 0);
            };
            _observers.push(self1);
            isNormalizer && _isViewport(target) && (_normalizer = self1);
            self1.enable(event);
        };
   ...
   * Club GSAP members, the agreement issued with that membership.
   * @author: Jack Doyle, jack@greensock.com
  */ var gsap$1, _coreInitted$1, _win$1, _doc$1, _docEl$1, _body$1, _root$1, _resizeDelay, _toArray, _clamp$1, _time2, _syncInterval, _refreshing, _pointerIsDown, _transformProp, _i, _prevWidth, _prevHeight, _autoRefresh, _sort, _suppressOverwrites, _ignoreResize, _normalizer$1, _ignoreMobileResize, _baseScreenHeight, _baseScreenWidth, _fixIOSBug, _context$1, _scrollRestoration, _div100vh, _100vh, _isReverted, _clampingMax, _limitCallbacks, _startup$1 = 1, _getTime$1 = Date.now, _time1 = _getTime$1(), _lastScrollTime = 0, _enabled = 0, _parseClamp = function _parseClamp(value, type, self1) {
        var clamp = _isString(value) && (value.substr(0, 6) === "clamp(" || value.indexOf("max") > -1);
        self1["_" + type + "Clamp"] = clamp;
    ...
    }, _callback = function _callback(self1, func) {
        if (self1.enabled) {
            var result = self1._ctx ? self1._ctx.add(function() {
                return func(self1);
            }) : func(self1);
            result && result.totalTime && (self1.callbackAnimation = result);
        }
        ...
        left: 0,
        top: 0
    }, _parsePosition = function _parsePosition(value, trigger, scrollerSize, direction, scroll, marker, markerScroller, self1, scrollerBounds, borderWidth, useFixedPosition, scrollerMax, containerAnimation, clampZeroProp) {
        _isFunction(value) && (value = value(self1));
        ...
        if (!_isNumber(value)) {
            _isFunction(trigger) && (trigger = trigger(self1));
            var offsets = (value || "0").split(" "), bounds, localOffset, globalOffset, display;
            element = _getTarget(trigger, self1) || _body$1;
        ...
        if (clampZeroProp) {
            self1[clampZeroProp] = value || -0.001;
            value < 0 && (value = 0);
        }
        if (marker) {
    ...
    var ScrollTrigger$1 = function() {
        ...
        _proto.init = function init(vars, animation) {
            ...
            var _vars = vars, onUpdate = _vars.onUpdate, toggleClass = _vars.toggleClass, id = _vars.id, onToggle = _vars.onToggle, onRefresh = _vars.onRefresh, scrub = _vars.scrub, trigger = _vars.trigger, pin = _vars.pin, pinSpacing = _vars.pinSpacing, invalidateOnRefresh = _vars.invalidateOnRefresh, anticipatePin = _vars.anticipatePin, onScrubComplete = _vars.onScrubComplete, onSnapComplete = _vars.onSnapComplete, once = _vars.once, snap = _vars.snap, pinReparent = _vars.pinReparent, pinSpacer = _vars.pinSpacer, containerAnimation = _vars.containerAnimation, fastScrollEnd = _vars.fastScrollEnd, preventOverlaps = _vars.preventOverlaps, direction = vars.horizontal || vars.containerAnimation && vars.horizontal !== false ? _horizontal : _vertical, isToggle = !scrub && scrub !== 0, scroller = _getTarget(vars.scroller || _win$1), scrollerCache = gsap$1.core.getCache(scroller), isViewport = _isViewport$1(scroller), useFixedPosition = ("pinType" in vars ? vars.pinType : _getProxyProp(scroller, "pinType") || isViewport && "fixed") === "fixed", callbacks = [
                ...
                vars.onEnterBack,
                vars.onLeaveBack
            ], toggleActions = isToggle && vars.toggleActions.split(" "), markers = "markers" in vars ? vars.markers : _defaults.markers, borderWidth = isViewport ? 0 : parseFloat(_getComputedStyle(scroller)["border" + direction.p2 + _Width]) || 0, self1 = this, onRefreshInit = vars.onRefreshInit && function() {
                return vars.onRefreshInit(self1);
            ...
            self1._startClamp = self1._endClamp = false;
            self1._dir = direction;
            anticipatePin *= 45;
            self1.scroller = scroller;
            self1.scroll = containerAnimation ? containerAnimation.time.bind(containerAnimation) : scrollFunc;
            scroll1 = scrollFunc();
            self1.vars = vars;
            animation = animation || vars.animation;
            if ("refreshPriority" in vars) {
                _sort = 1;
                vars.refreshPriority === -9999 && (_primary = self1);
            }
            scrollerCache.tweenScroll = scrollerCache.tweenScroll || {
                top: _getTweenCreator(scroller, _vertical),
                left: _getTweenCreator(scroller, _horizontal)
            };
            self1.tweenTo = tweenTo = scrollerCache.tweenScroll[direction.p];
            self1.scrubDuration = function(value) {
                ...
                if (!scrubSmooth) {
                    ...
                    scrubTween ? scrubTween.duration(value) : scrubTween = gsap$1.to(animation, {
                        ...
                        onComplete: function onComplete() {
                            return onScrubComplete && onScrubComplete(self1);
                        }
                    });
                }
            };
            if (animation) {
                ...
                animation._initted && !self1.isReverted || animation.vars.immediateRender !== false && vars.immediateRender !== false && animation.duration() && animation.render(0, true, true);
                self1.animation = animation.pause();
                animation.scrollTrigger = self1;
                self1.scrubDuration(scrub);
                snap1 = 0;
            ...
            if (snap) {
                ...
                snapDelayedCall = gsap$1.delayedCall(snap.delay || scrubSmooth / 2 || 0.1, function() {
                    ...
                    if ((refreshedRecently || Math.abs(self1.getVelocity()) < 10) && !tween && !_pointerIsDown && lastSnap !== scroll) {
                        ...
                        endValue = snapFunc(naturalEnd, self1);
                        ...
                        if (scroll <= end && scroll >= start && endScroll !== scroll) {
                            ...
                            tweenTo(endScroll, {
                                ...
                                onInterrupt: function onInterrupt() {
                                    return snapDelayedCall.restart(true) && _onInterrupt && _onInterrupt(self1);
                                },
                                onComplete: function onComplete() {
                                    self1.update();
                                    lastSnap = scrollFunc();
                                    ...
                                    snap1 = snap2 = animation && !isToggle ? animation.totalProgress() : self1.progress;
                                    onSnapComplete && onSnapComplete(self1);
                                    _onComplete && _onComplete(self1);
                                }
                            }, scroll, change1 * change, endScroll - scroll - change1 * change);
                            onStart && onStart(self1, tweenTo.tween);
                        }
                    } else if (self1.isActive && lastSnap !== scroll) {
                        snapDelayedCall.restart(true);
                    }
                }).pause();
            }
            id && (_ids[id] = self1);
            trigger = self1.trigger = _getTarget(trigger || pin !== true && pin);
            customRevertReturn = trigger && trigger._gsap && trigger._gsap.stRevert;
            customRevertReturn && (customRevertReturn = customRevertReturn(self1));
            ...
            if (pin) {
                ...
                self1.spacer = spacer = pinCache.spacer;
            ...
            self1.previous = function() {
                return _triggers[_triggers.indexOf(self1) - 1];
            };
            self1.next = function() {
                return _triggers[_triggers.indexOf(self1) + 1];
            };
            self1.revert = function(revert, temp) {
                if (!temp) {
                    return self1.kill(true);
                }
                var r = revert !== false || !self1.enabled, prevRefreshing = _refreshing;
                if (r !== self1.isReverted) {
                    if (r) {
                        prevScroll = Math.max(scrollFunc(), self1.scroll.rec || 0);
                        prevProgress = self1.progress;
                    ...
                    if (pin && (!pinReparent || !self1.isActive)) {
                        if (r) {
            ...
            self1.refresh = function(soft, force, position, pinOffset) {
                if ((_refreshing || !self1.enabled) && !force) {
                    return;
                }
                ...
                !_refreshingAll && onRefreshInit && onRefreshInit(self1);
                _refreshing = self1;
                ...
                self1.isReverted || self1.revert(true, true);
                self1._subPinOffset = false;
                var size = getScrollerSize(), scrollerBounds = getScrollerOffsets(), max = containerAnimation ? containerAnimation.duration() : _maxScroll(scroller, direction), isFirstRefresh = change <= 0.01, offset = 0, otherPinOffset = pinOffset || 0, parsedEnd = _isObject(position) ? position.end : vars.end, parsedEndTrigger = vars.endTrigger || trigger, parsedStart = _isObject(position) ? position.start : vars.start || (vars.start === 0 || !trigger ? 0 : pin ? "0 0" : "0 100%"), pinnedContainer = self1.pinnedContainer = vars.pinnedContainer && _getTarget(vars.pinnedContainer, self1), triggerIndex = trigger && Math.max(0, _triggers.indexOf(self1)) || 0, i = triggerIndex, cs, bounds, scroll, isVertical, override, curTrigger, curPin, oppositeScroll, initted, revertedPins, forcedOverflow, markerStartOffset, markerEndOffset;
                ...
                while(i--){
                    ...
                    curTrigger.end || curTrigger.refresh(0, 1) || (_refreshing = self1);
                ...
                _isFunction(parsedStart) && (parsedStart = parsedStart(self1));
                parsedStart = _parseClamp(parsedStart, "start", self1);
                start = _parsePosition(parsedStart, trigger, size, direction, scrollFunc(), markerStart, markerStartTrigger, self1, scrollerBounds, borderWidth, useFixedPosition, max, containerAnimation, self1._startClamp && "_startClamp") || (pin ? -0.001 : 0);
                _isFunction(parsedEnd) && (parsedEnd = parsedEnd(self1));
                ...
                parsedEnd = _parseClamp(parsedEnd, "end", self1);
                end = Math.max(start, _parsePosition(parsedEnd || (parsedEndTrigger ? "100% 0" : max), parsedEndTrigger, size, direction, scrollFunc() + offset, markerEnd, markerEndTrigger, self1, scrollerBounds, borderWidth, useFixedPosition, max, containerAnimation, self1._endClamp && "_endClamp")) || -0.001;
                offset = 0;
                i = triggerIndex;
                while(i--){
                    curTrigger = _triggers[i];
                    ...
                    if (curPin && curTrigger.start - curTrigger._pinPush <= start && !containerAnimation && curTrigger.end > 0) {
                        cs = curTrigger.end - (self1._startClamp ? Math.max(0, curTrigger.start) : curTrigger.start);
                ...
                self1._startClamp && (self1._startClamp += offset);
                if (self1._endClamp && !_refreshingAll) {
                    self1._endClamp = end || -0.001;
                ...
                if (pin && !(_clampingMax && self1.end >= _maxScroll(scroller, direction))) {
                    cs = _getComputedStyle(pin);
                ...
                if (isFirstRefresh || prevProgress !== self1.progress || containerAnimation || invalidateOnRefresh) {
                    ...
                    self1.progress = isFirstRefresh || (scroll1 - start) / change === prevProgress ? 0 : prevProgress;
                }
                pin && pinSpacing && (spacer._pinOffset = Math.round(self1.progress * pinChange));
                ...
                isFirstRefresh && !_refreshingAll && self1.update();
            ...
            self1.getVelocity = function() {
                return (scrollFunc() - scroll2) / (_getTime$1() - _time2) * 1000 || 0;
            };
            self1.endAnimation = function() {
                _endAnimation(self1.callbackAnimation);
                if (animation) {
                    scrubTween ? scrubTween.progress(1) : !animation.paused() ? _endAnimation(animation, animation.reversed()) : isToggle || _endAnimation(animation, self1.direction < 0, 1);
                }
            };
            self1.labelToScroll = function(label) {
                return animation && animation.labels && (start || self1.refresh() || start) + animation.labels[label] / animation.duration() * change || 0;
            };
            self1.getTrailing = function(name) {
                var i = _triggers.indexOf(self1), a = self1.direction > 0 ? _triggers.slice(0, i).reverse() : _triggers.slice(i + 1);
                return (_isString(name) ? a.filter(function(t) {
                    return t.vars.preventOverlaps === name;
                }) : a).filter(function(t) {
                    return self1.direction > 0 ? t.end <= start : t.start >= end;
                });
            };
            self1.update = function(reset, recordVelocity, forceFake) {
                if (containerAnimation && !forceFake && !reset) {
                    return;
                }
                var scroll = _refreshingAll === true ? prevScroll : self1.scroll(), p = reset ? 0 : (scroll - start) / change, clipped = p < 0 ? 0 : p > 1 ? 1 : p || 0, prevProgress = self1.progress, isActive, wasActive, toggleState, action, stateChanged, toggled, isAtMax, isTakingAction;
                if (recordVelocity) {
                    scroll2 = scroll1;
                ...
                if (clipped !== prevProgress && self1.enabled) {
                    isActive = self1.isActive = !!clipped && clipped < 1;
                    wasActive = !!prevProgress && prevProgress < 1;
                    toggled = isActive !== wasActive;
                    stateChanged = toggled || !!clipped !== !!prevProgress;
                    self1.direction = clipped > prevProgress ? 1 : -1;
                    self1.progress = clipped;
                    ...
                    preventOverlaps && (toggled || isTakingAction) && (isTakingAction || scrub || !animation) && (_isFunction(preventOverlaps) ? preventOverlaps(self1) : self1.getTrailing(preventOverlaps).forEach(function(t) {
                    ...
                    onUpdate && !isToggle && !reset && onUpdate(self1);
                    if (stateChanged && !_refreshing) {
                        if (isToggle) {
                            if (isTakingAction) {
                                if (action === "complete") {
                            ...
                            onUpdate && onUpdate(self1);
                        }
                        if (toggled || !_limitCallbacks) {
                            onToggle && toggled && _callback(self1, onToggle);
                            callbacks[toggleState] && _callback(self1, callbacks[toggleState]);
                            once && (clipped === 1 ? self1.kill(false, 1) : callbacks[toggleState] = 0);
                            if (!toggled) {
                                toggleState = clipped === 1 ? 1 : 3;
                                callbacks[toggleState] && _callback(self1, callbacks[toggleState]);
                            }
                        }
                        if (fastScrollEnd && !isActive && Math.abs(self1.getVelocity()) > (_isNumber(fastScrollEnd) ? fastScrollEnd : 2500)) {
                            _endAnimation(self1.callbackAnimation);
            ...
            self1.enable = function(reset, refresh) {
                if (!self1.enabled) {
                    self1.enabled = true;
                    ...
                    if (reset !== false) {
                        self1.progress = prevProgress = 0;
                        scroll1 = scroll2 = lastSnap = scrollFunc();
                    }
                    refresh !== false && self1.refresh();
                }
            };
            self1.getTween = function(snap) {
                return snap && tweenTo ? tweenTo.tween : scrubTween;
            };
            self1.setPositions = function(newStart, newEnd, keepClamp, pinOffset) {
                if (containerAnimation) {
                    var st = containerAnimation.scrollTrigger, duration = containerAnimation.duration(), _change = st.end - st.start;
                    newStart = st.start + _change * newStart / duration;
                    newEnd = st.start + _change * newEnd / duration;
                }
                self1.refresh(false, false, {
                    start: _keepClamp(newStart, keepClamp && !!self1._startClamp),
                    end: _keepClamp(newEnd, keepClamp && !!self1._endClamp)
                }, pinOffset);
                self1.update();
            };
            self1.adjustPinSpacing = function(amount) {
            ...
            self1.disable = function(reset, allowAnimation) {
                if (self1.enabled) {
                    reset !== false && self1.revert(true, true);
                    self1.enabled = self1.isActive = false;
                    ...
                    if (!isViewport) {
                        ...
                        while(i--){
                            if (_triggers[i].scroller === scroller && _triggers[i] !== self1) {
                                return;
                            }
                        }
            ...
            self1.kill = function(revert, allowAnimation) {
                self1.disable(revert, allowAnimation);
                scrubTween && !allowAnimation && scrubTween.kill();
                id && delete _ids[id];
                var i = _triggers.indexOf(self1);
                i >= 0 && _triggers.splice(i, 1);
                i === _i && _direction > 0 && _i--;
                i = 0;
                _triggers.forEach(function(t) {
                    return t.scroller === self1.scroller && (i = 1);
                });
                i || _refreshingAll || (self1.scroll.rec = 0);
                if (animation) {
                ...
                vars.onKill && vars.onKill(self1);
            };
            _triggers.push(self1);
            self1.enable(false, false);
            customRevertReturn && customRevertReturn(self1);
            if (animation && animation.add && !change) {
                var updateFunc = self1.update;
                self1.update = function() {
                    self1.update = updateFunc;
                    start || end || self1.refresh();
                };
                gsap$1.delayedCall(0.01, self1.update);
                change = 0.01;
                start = end = 0;
            } else {
                self1.refresh();
    ...
    var _clampScrollAndGetDurationMultiplier = function _clampScrollAndGetDurationMultiplier(scrollFunc, current, end, max) {
        ...
        vars.ignoreCheck = function(e) {
            return _fixIOSBug && e.type === "touchmove" && ignoreDrag() || scale > 1.05 && e.type !== "touchstart" || self1.isGesturing || e.touches && e.touches.length > 1;
        };
        ...
        vars.onRelease = vars.onGestureStart = function(self1, wasDragging) {
            scrollFuncY.offset && removeContentOffset();
            if (!wasDragging) {
                ...
                if (normalizeScrollX) {
                    ...
                    endScroll = currentScroll + dur * 0.05 * -self1.velocityX / 0.227;
                    dur *= _clampScrollAndGetDurationMultiplier(scrollFuncX, currentScroll, endScroll, _maxScroll(target, _horizontal));
                    tween.vars.scrollX = scrollClampX(endScroll);
                }
                currentScroll = scrollFuncY();
                endScroll = currentScroll + dur * 0.05 * -self1.velocityY / 0.227;
        ...
        vars.onChange = function(self1, dx, dy, xArray, yArray) {
            _refreshID !== lastRefreshID && updateClamps();
            dx && normalizeScrollX && scrollFuncX(scrollClampX(xArray[2] === dx ? startScrollX + (self1.startX - self1.x) : scrollFuncX() + dx - xArray[1]));
            if (dy) {
                scrollFuncY.offset && removeContentOffset();
                var isTouch = yArray[2] === dy, y = isTouch ? startScrollY + self1.startY - self1.y : scrollFuncY() + dy - yArray[1], yClamped = scrollClampY(y);
        ...
        self1 = new Observer(vars);
        self1.iOS = _fixIOSBug;
        _fixIOSBug && !scrollFuncY() && scrollFuncY(1);
        _fixIOSBug && gsap$1.ticker.add(_passThrough);
        onStopDelayedCall = self1._dc;
        tween = gsap$1.to(self1, {
            ease: "power4",
            paused: true,
            inherit: false,
...
//# sourceMappingURL=node_modules_gsap_a4b805._.js.map